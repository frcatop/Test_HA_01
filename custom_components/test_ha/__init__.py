"""
Custom integration to integrate test_ha with Home Assistant.

For more details about this integration, please refer to:
https://github.com/frcatop/Test_HA_01
"""
...
from .data import TestHAData
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import TestHAConfigEntry
