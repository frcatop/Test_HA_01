"""Config flow for test_ha — user setup, reconfigure and reauth."""

from typing import Any

from custom_components.test_ha.api import TestHAApiClientAuthenticationError, TestHAApiClientCommunicationError
from custom_components.test_ha.const import DOMAIN, LOGGER
...
class TestHAConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle the config flow for test_ha."""
    ...
    async def _async_validate(self, user_input: dict[str, Any]) -> dict[str, str]:
        ...
        except TestHAApiClientAuthenticationError:
            return {"base": "invalid_auth"}
        except TestHAApiClientCommunicationError:
...
__all__ = ["TestHAConfigFlowHandler"]
