# Getting Started with Test HA

This guide will help you install and set up the Test HA custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/frcatop/Test_HA_01`
6. Set category to "Integration"
7. Click "Add"
8. Find "Test HA" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/frcatop/Test_HA_01/releases)
2. Extract the `test_ha` folder from the archive
3. Copy it to `custom_components/test_ha/` in your Home Assistant configuration directory
...
4. Select entities from "Test HA"
...
- Report issues at [GitHub Issues](https://github.com/frcatop/Test_HA_01/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/frcatop/Test_HA_01/discussions)
